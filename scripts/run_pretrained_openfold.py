    ...
    for model, output_directory in model_generator:
        ...
        for (tag, tags), seqs in sorted_targets:
            ...
            if args.embeddings_output_path is not None:
                ...
                for _p in embeddings_keys:
                    if not _p in embeddings:
                        del embeddings[_p]
                torch.save(embeddings, args.embeddings_output_path)
